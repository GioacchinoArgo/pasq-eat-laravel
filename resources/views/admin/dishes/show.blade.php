...
<section class="p-3 my-5">
    <div class="glass-card spacing w-75 px-4 pb-4">    
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-12 justify-content-center">
                <div class="button-group">
                    <div class="gap-2 mt-4 d-flex align-items-center justify-content-between justify-content-md-between">
                        {{--# TORNA INDIETRO --}}
                        <a href="{{route('admin.dishes.index')}}" class="btn-outline-index fw-semibold gray ms-1 px-3 py-2 rounded-pill d-flex align-items-center fw-semibold">
                            <i class="fa-solid fa-left-long"></i>
                            <span class="d-none ms-2 d-lg-block">Torna indietro</span>
                        </a>
                        <div class="d-flex gap-2 justify-content-md-end">
                            {{--# EDIT --}}
                            <a href="{{ route('admin.dishes.edit', $dish->id)}}" class="btn-outline-index fw-semibold yellow ms-1 px-3 py-2 rounded-pill d-flex align-items-center edit">
                            ...
                            <form action="{{ route('admin.dishes.destroy', $dish->id) }}" method="POST" id="delete-form">
                                @csrf
                                @method('DELETE')
                                <button class="btn-outline-index fw-semibold red ms-1 px-3 py-2 rounded-pill d-flex align-items-center text-center">
