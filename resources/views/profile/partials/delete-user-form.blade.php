<section class="space-y-6">
    ...
    <button type="button" class="data-btn red ms-1 px-3 py-1 rounded-pill" data-bs-toggle="modal" data-bs-target="#delete-account">
        {{__('Cancella account')}}
    </button>
    ...
    <div class="modal fade" id="delete-account" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="delete-account" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content rounded-4 p-4">
                ...
                <div class="d-flex justify-content-between align-items-center ms-3">
                    <button type="button" class="data-btn gray fw-semibold gray ms-1 px-3 py-2 rounded-pill d-flex align-items-center" data-bs-dismiss="modal">Chiudi</button>
                    ...
                    <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
                        ...
                        <div class="input-group">
                            ...
                            <button type="submit" class="data-btn red fw-semibold red ms-1 px-3 py-2 rounded-pill">
                                {{ __('Elimina Account') }}
                            </button>
                        </div>
                    </form>
